...
DEFAULT_OUTPUT = PROJECT_ROOT / "user_docs" / "PROJECT_DOCUMENTATION_COMPLETE.md"
...
CHAPTERS = [
    ...
    Chapter(2, "文档导航与阅读地图", "2.1", "文档索引与推荐阅读顺序", "user_docs/README.md"),
    Chapter(2, "文档导航与阅读地图", "2.2", "核心技术全景与项目学习手册", "user_docs/PROJECT_LEARNING_MANUAL.md"),
    Chapter(3, "总体架构与多 Agent 系统", "3.1", "系统总体架构", "user_docs/architecture.md"),
    Chapter(3, "总体架构与多 Agent 系统", "3.2", "医疗多 Agent 系统设计", "user_docs/medical-multi-agent-design.md"),
    Chapter(4, "医学知识、检索与训练数据", "4.1", "医学知识检索与证据融合", "user_docs/medical-knowledge-retrieval-design.md"),
    Chapter(4, "医学知识、检索与训练数据", "4.2", "中国临床知识治理与合规入库", "user_docs/chinese-medical-knowledge-governance.md"),
    Chapter(4, "医学知识、检索与训练数据", "4.3", "中文医疗 NLP 与 Agent Benchmark", "user_docs/chinese-medical-benchmarks.md"),
    Chapter(4, "医学知识、检索与训练数据", "4.4", "医学微调数据说明", "data/medical_finetune/README.md"),
    Chapter(5, "状态、上下文与随访闭环", "5.1", "三层记忆系统设计", "user_docs/memory-system-design.md"),
    Chapter(5, "状态、上下文与随访闭环", "5.2", "Token 与上下文预算优化", "user_docs/token-optimization-design.md"),
    Chapter(5, "状态、上下文与随访闭环", "5.3", "回诊与随访系统设计", "user_docs/follow-up-system-design.md"),
    Chapter(6, "安全、评测与可靠性", "6.1", "安全防御体系", "user_docs/security-defense-design.md"),
    Chapter(6, "安全、评测与可靠性", "6.2", "统一评测方法", "user_docs/evaluation-methodology.md"),
    Chapter(7, "工程实现、基线与展示", "7.1", "LangChain 与 LangGraph 实现", "user_docs/langchain-langgraph-implementation.md"),
    Chapter(7, "工程实现、基线与展示", "7.2", "MySQL 部署与迁移", "user_docs/mysql-deployment.md"),
    Chapter(7, "工程实现、基线与展示", "7.3", "RAGFlow 基线方案", "user_docs/ragflow-baseline.md"),
    Chapter(7, "工程实现、基线与展示", "7.4", "Web 可视化控制台设计", "user_docs/web-visualization-design.md"),
    Chapter(7, "工程实现、基线与展示", "7.5", "Program MVP 运行说明", "program/README.md"),
    Chapter(8, "简历与面试材料", "8.1", "Interview Pack", "user_docs/interview-pack.md"),
...
def is_generated_or_ignored(path: Path) -> bool:
    ...
    return (
        relative == "user_docs/PROJECT_DOCUMENTATION_COMPLETE.md"
        or relative.startswith((".agents/", ".github/", ".specify/", "develop_kit/"))
        or relative.startswith("data/medical_finetune/raw/")
        or relative.startswith("data/benchmarks/")
        or relative.startswith("reports/")
        or any(
            part in {".venv", "venv", "site-packages", "node_modules", ".git"} for part in path.parts
        )
    )
